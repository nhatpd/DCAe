...
fprintf('runing DCA \n');
    method = 1;
    [out{method}] = DCA( train_Data, lambda, theta, para );

fprintf('runing iDCA \n');
    method = 2;
    [out{method}] = iDCA( train_Data, lambda, theta, para ); 

fprintf('runing DCAe \n');
    method = 3;
    [out{method}] = DCAe( train_Data, lambda, theta, para );
